...
const intro = magpieViews.view_generator("intro", {
    ...
    text:   `Hello and welcome to this experiment!
            <br />
            Thank you for your participation. The following part will introduce you to the experiment. Have fun!
            <br />`,
...
const instructions_practice = magpieViews.view_generator("instructions", {
    ...
    text:  `There will be pictures with pairs of geometrical objects. If both objects in the pair is equal you need to press "F". If they are different, press "J". Please try to answer as quick and accurately as possible!
            <br />
            <br />
            First, we are going to have a practice trial.`,
...
const instructions_main = magpieViews.view_generator("instructions", {
    ...
    text:  `After this practice trial we are going to the actual experiment. Please try to answer again as quickly and accurately as possible!`,
    buttonText: 'begin'
});
...
const thanks = magpieViews.view_generator("thanks", {
    trials: 1,
    name: 'thanks',
    title: 'Thank you for being a part of this experiment! We hope you enjoyed your time. Have a nice day, sir!',
